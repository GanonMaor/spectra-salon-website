...
async function fixMonthlyMatrixImport() {
  ...
  try {
    ...
    // Read the Excel file
    const excelPath = path.join(__dirname, 'data', 'raw', 'summit_payments_detailed.xlsx');
    ...
    console.log(`✅ Successfully imported ${totalPayments} payments from monthly matrix`);
    ...
    console.log(`🔗 Linked ${linkResult.rowCount} payment records to customers`);
