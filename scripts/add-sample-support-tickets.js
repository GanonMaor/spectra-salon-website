...
const sampleTickets = [
  {
    ...
    message: "Hi! I'm interested in your color tracking system. Can you tell me more about the pricing for a medium-sized salon?",
    source_page: "chat"
  },
  {
    name: "Michael Chen",
    ...
    message: "Hello, I saw your WhatsApp button and wanted to ask about installation process. How long does it take?",
  ...
  },
  {
    ...
    message: "We're considering your system for our 3 locations. Do you offer bulk pricing?",
    source_page: "/"
  }
];
  ...
  for (const ticket of sampleTickets) {
    try {
      ...
      if (response.ok) {
        ...
        console.log(`❌ Failed to add ticket for ${ticket.email}: ${response.status}`);
      }
    } catch (error) {
