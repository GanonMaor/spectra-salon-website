...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    console.log('Running migration 10: Seed Salon Look customers...');

    // Insert 120 customers for Salon Look
    await sql`
    ...
    console.log('Customers inserted. Seeding visits...');

    // Insert visit history for seeded customers
    await sql`
    ...
    return {
      ...
      body: JSON.stringify({
        success: true,
        message: 'Migration 10 completed - 120 customers + 40 visits seeded for Salon Look'
      })
    };
