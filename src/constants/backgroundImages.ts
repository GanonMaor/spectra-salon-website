export const BACKGROUND_IMAGES = {
  // Your new image for the homepage
  yourCustomSalon:
  ...
  // Color rooms and professional salons
  professionalSalon:
    "https://images.unsplash.com/photo-1633681926022-84c23e8cb2d6?q=80&w=2940&auto=format&fit=crop", // Professional salon with chairs
  colorStation:
    "https://images.unsplash.com/photo-1562322140-8baeececf3df?q=80&w=2940&auto=format&fit=crop", // Professional color station

  // Hair color world
  hairColorPalette:
    "https://images.unsplash.com/photo-1552693673-1bf958298935?q=80&w=2940&auto=format&fit=crop",
  colorTubes:
    "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=2940&auto=format&fit=crop", // Professional hair colors

  // Boutique salons
  boutiqueSalon:
    "https://images.unsplash.com/photo-1559599101-f09722fb4948?q=80&w=2940&auto=format&fit=crop",
  minimalistSalon:
    "https://images.unsplash.com/photo-1580618672591-eb180b1a973f?q=80&w=2940&auto=format&fit=crop", // Minimalist salon
};
