          ...
          <NotificationProvider>
            <ToastProvider>
              ...
              >
                ...
                <Route path="sales/utm-reporting" element={<UTMReportingPage />} />
                <Route path="sales/regional-funnel" element={<RegionalFunnelPage />} />
                
                {/* Success */}
                <Route path="success/onboarding-status" element={<OnboardingStatusPage />} />
                <Route path="success/video-call-requests" element={<VideoCallRequestsPage />} />
                ...
                <Route path="support/hardware-status" element={<HardwareStatusPage />} />
                
                {/* Live Support */}
                <Route path="live/zoom-links" element={<ZoomLinksPage />} />
                <Route path="live/help-videos" element={<HelpVideosPage />} />
                <Route path="live/diagnostics" element={<DiagnosticsPage />} />
                
                {/* Logs */}
                <Route path="logs/user-actions" element={<UserActionsPage />} />
                <Route path="logs/usage-heatmap" element={<UsageHeatmapPage />} />
