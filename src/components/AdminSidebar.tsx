      ...
      items: [
        {
          ...
          path: "/admin/success/onboarding-status",
        },
        {
          id: "video-call-requests",
          label: "Video Call Requests",
          path: "/admin/success/video-call-requests",
        },
        {
          id: "ai-alerts",
          label: "AI Alerts",
          path: "/admin/success/ai-alerts",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "unified-chat",
          label: "Unified Chat",
          path: "/admin/support/unified-chat",
        },
        {
        ...
        },
        {
          id: "error-logs",
          label: "Error Logs",
          path: "/admin/support/error-logs",
        },
        { id: "reweighs", label: "Reweighs", path: "/admin/support/reweighs" },
        {
          id: "formula-fails",
          label: "Formula Fails",
          path: "/admin/support/formula-fails",
        },
        {
          id: "hardware-status",
          label: "Hardware Status",
          path: "/admin/support/hardware-status",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "zoom-links",
          label: "Zoom Links",
          path: "/admin/live/zoom-links",
        },
        {
          id: "help-videos",
          label: "Help Videos",
          path: "/admin/live/help-videos",
        },
        {
          id: "diagnostics",
          label: "Diagnostics",
          path: "/admin/live/diagnostics",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "user-actions",
          label: "User Actions",
          path: "/admin/logs/user-actions",
        },
        {
          id: "usage-heatmap",
          label: "Usage Heatmap",
          path: "/admin/logs/usage-heatmap",
        },
      ...
      <div className="flex items-center justify-between p-6 border-b border-gray-200">
        <div className="flex items-center">
          <img
            ...
            alt="Spectra"
            className={`${isCollapsed ? "h-6" : "h-8"} w-auto transition-all duration-300`}
          />
        </div>
                  ...
                  {!isCollapsed && (
                    <>
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        {group.id === "support" &&
                          (stats.unreadCount > 0 || unreadCount > 0) && (
                            <NotificationBadge
