...
import { MegaphoneIcon, CheckCircleIcon, CurrencyDollarIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="flex gap-6 mb-8">
      <KPICard
        ...
        changeType={kpiData.leadsFromCampaigns.changeType === 'increase' ? 'positive' : 'negative'}
