    ...
    <section className="relative py-12 lg:py-16 overflow-hidden max-w-full">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extralight text-white mb-4 leading-[1.1] tracking-[-0.02em]">
            {title}{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#EAB776] to-[#B18059]">
              {subtitle}
            </span>
          </h2>
          <p className="text-lg lg:text-xl text-white/40 max-w-2xl mx-auto leading-relaxed font-light">
            {description}
          </p>
        </div>
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="bg-black/70 backdrop-blur-md rounded-3xl border border-white/[0.08] p-8 lg:p-10">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-base text-white/40 font-light max-w-xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-2xl mx-auto">
                  {[
                    ...
                    <a
                      ...
                      className="group bg-black/50 hover:bg-black/70 backdrop-blur-sm rounded-xl p-4 border border-white/[0.08] hover:border-[#EAB776]/30 transition-all duration-300 text-center cursor-pointer"
                    >
                      <div className="text-white/80 text-sm font-medium mb-1 group-hover:text-white">
                        {slot.day}
                      </div>
                      <div className="text-white/40 text-xs group-hover:text-white/60">
                        {slot.time}
                      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 mb-16 max-w-4xl mx-auto">
          ...
          >
            ...
            <h3 className="text-white font-medium text-sm mb-1">Instagram</h3>
          ...
          <a
            ...
            className="group bg-black/50 hover:bg-black/70 backdrop-blur-sm rounded-2xl border border-white/[0.08] hover:border-white/15 p-6 text-center transition-all duration-300"
          >
            <div className="w-12 h-12 bg-gradient-to-br from-[#EAB776]/20 to-[#B18059]/20 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
              <svg className="w-6 h-6 text-[#D4A06A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <h3 className="text-white font-medium text-sm mb-1">Call</h3>
            <p className="text-white/40 text-xs">+972-50-432-2680</p>
          </a>
        </div>
        ...
        <div className="flex justify-center items-center gap-4 mb-12">
          ...
          <a href="https://www.linkedin.com/company/spectra-ci" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-black/50 hover:bg-black/70 rounded-xl border border-white/[0.08] flex items-center justify-center transition-all hover:scale-110">
            <svg className="w-5 h-5 text-white/50 hover:text-blue-400" fill="currentColor" viewBox="0 0 24 24">
              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
            </svg>
          </a>
          <a href="https://www.facebook.com/share/1CFHR3osmZ/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-black/50 hover:bg-black/70 rounded-xl border border-white/[0.08] flex items-center justify-center transition-all hover:scale-110">
            <svg className="w-5 h-5 text-white/50 hover:text-blue-500" fill="currentColor" viewBox="0 0 24 24">
