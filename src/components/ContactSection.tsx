            ...
            <div className="relative p-8 lg:p-12 bg-white/15 backdrop-blur-3xl rounded-[3rem] border border-white/25 shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 mb-8 border border-white/20">
                  <h4 className="text-white font-semibold mb-4">Available This Week:</h4>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <div className="bg-white/15 backdrop-blur-xl rounded-xl p-3 border border-white/20 hover:bg-white/20 transition-all duration-300 cursor-pointer group">
                      <div className="text-white/90 text-sm font-medium">Tomorrow</div>
                      <div className="text-white/70 text-xs">10:00 AM</div>
                      <div className="w-2 h-2 bg-green-400 rounded-full mt-2 group-hover:scale-125 transition-transform"></div>
                    </div>
                    <div className="bg-white/15 backdrop-blur-xl rounded-xl p-3 border border-white/20 hover:bg-white/20 transition-all duration-300 cursor-pointer group">
                      <div className="text-white/90 text-sm font-medium">Wed</div>
                      <div className="text-white/70 text-xs">3:30 PM</div>
                      <div className="w-2 h-2 bg-green-400 rounded-full mt-2 group-hover:scale-125 transition-transform"></div>
                    </div>
                    <div className="bg-white/15 backdrop-blur-xl rounded-xl p-3 border border-white/20 hover:bg-white/20 transition-all duration-300 cursor-pointer group">
                      <div className="text-white/90 text-sm font-medium">Thu</div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-2 gap-6 mb-16 max-w-4xl mx-auto">
          ...
          <div className="group relative">
            ...
            >
              ...
              <div className="relative flex flex-col items-center text-center h-full justify-center">
                ...
                <h3 className="text-xl font-bold text-white mb-2 tracking-tight">WhatsApp</h3>
          ...
          <div className="group relative">
            ...
            <button 
              ...
              onClick={() => {
                const message = "Hi! I'm interested in learning more about Spectra. Can you help me get started?";
                ...
                `;
                notification.className = 'fixed top-4 right-4 bg-gray-900 text-white px-4 py-3 rounded-lg shadow-xl z-50 border border-gray-700';
            ...
            >
              ...
              <div className="relative flex flex-col items-center text-center h-full justify-center">
                ...
                <h3 className="text-xl font-bold text-white mb-2 tracking-tight">Instagram DM</h3>
          ...
          <div className="group relative">
            ...
            >
              ...
              <div className="relative flex flex-col items-center text-center h-full justify-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-2 tracking-tight">Email Us</h3>
          ...
          <div className="group relative">
            ...
            >
              ...
              <div className="relative flex flex-col items-center text-center h-full justify-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-2 tracking-tight">Call Us</h3>
