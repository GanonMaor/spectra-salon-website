...
export const THREE_LAYERS = {
  eyebrow: "Product Roadmap & Company Evolution",
  headline: "A long-term strategy already in motion.",
  layers: [
    {
      num: "Layer 1",
      title: "Cost Optimization",
      status: "Live & Growing",
      detail: "Paying customers across 12 countries. Proven unit economics. The foundation of our data layer.",
      milestones: ["Paying customers", "CAC:LTV = 1:5", "Data layer live"],
    },
    {
      num: "Layer 2",
      title: "Booking Intelligence",
      status: "Built — Testing",
      detail: "Smart Booking + CRM + POS. Currently in testing. Soft launch to 30 existing customers in 45 days.",
      milestones: ["45-day soft launch", "30 early adopters", "All-in-one booking"],
    },
    {
      num: "Layer 3",
      title: "Salon Operating System",
      status: "September 2026",
      detail: "Edge app connecting salon owner, staff, and clients. Internal and external communication. Full remote management.",
      milestones: ["Management app", "Communication layer", "Remote control"],
    },
    {
      num: "Layer 4",
      title: "Salon AI Agent Suite",
      status: "January 2027",
      detail: "Five dedicated AI agents that perform hundreds of daily operational tasks, not just generate insights.",
      milestones: ["Agent packages", "Token economy", "AI-native operations"],
    },
  ],
  closing: "Cost Optimization → Booking Intelligence → Salon OS → Salon AI",
} as const;
