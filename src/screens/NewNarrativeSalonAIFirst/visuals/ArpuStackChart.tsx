...
const LAYERS: Layer[] = [
  ...
  { id: "ops", label: "Booking & POS", amount: 960, accent: ACCENTS.sage.accent, accentDeep: ACCENTS.sage.accentDeep },
  { id: "ai", label: "Salon AI", amount: 4080, accent: ACCENTS.gold.accent, accentDeep: ACCENTS.gold.accentDeep },
];
...
const STAGES = [
  ...
  { id: "s3", upto: 2, total: "$6,000+", caption: "+ Salon AI" },
];
