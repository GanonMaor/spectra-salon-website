  ...
  return (
    <div className="bg-white">
      ...
      <Slide footer="Source: Customer testimonials & Instagram analytics">
        ...
        {/* Instagram Social Proof - Compact */}
        <div className="bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 rounded-2xl p-6 sm:p-8 mb-8 sm:mb-10 text-center shadow-lg relative overflow-hidden max-w-3xl mx-auto">
          <div className="absolute top-0 right-0 w-48 h-48 bg-white/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-40 h-40 bg-white/10 rounded-full blur-3xl"></div>
          
          <div className="relative z-10">
            <div className="inline-block bg-white/20 backdrop-blur-sm rounded-2xl p-3 mb-3">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">@spectra.ci</h3>
            
            <div className="flex justify-center gap-6 sm:gap-8 mb-5">
              <div>
                <p className="text-2xl sm:text-3xl font-bold text-white">8.2K</p>
                <p className="text-xs sm:text-sm text-white/80">Followers</p>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-bold text-white">116</p>
                <p className="text-xs sm:text-sm text-white/80">Posts</p>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-bold text-white">3.3K</p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-white text-purple-600 px-5 py-2.5 rounded-full font-semibold text-sm hover:bg-gray-100 transition-all hover:scale-105 shadow-lg"
            >
