...
const features: Feature[] = [
  {
    ...
    description:
      "Never run out of color again with AI-powered inventory tracking.",
    longDescription:
      "Revolutionary inventory management that tracks every drop of color in real-time. Smart alerts notify you before you run out, automatic reorder suggestions, and detailed usage analytics help you optimize your stock levels.",
    icon: "📱",
  ...
  },
  {
    ...
    longDescription:
      "AI-powered color mixing that calculates exact formulas for every client. No more guesswork, no more waste. Perfect color matching every time with our proprietary algorithm.",
    icon: "🎨",
  ...
  },
  {
    ...
    longDescription:
      "Advanced AI analytics that learn from your salon's patterns. Predict seasonal trends, optimize inventory, and get actionable insights to boost profitability.",
    icon: "🧠",
  ...
  },
  {
    ...
    longDescription:
      "Monitor your salon's performance in real-time. Live dashboards show color usage, waste metrics, profit margins, and efficiency scores as they happen.",
    icon: "📊",
  ...
  },
  {
    ...
    longDescription:
      "Comprehensive salon management suite that brings everything together. Manage staff, schedule appointments, track inventory, and monitor performance from one elegant dashboard.",
    icon: "💼",
    image: "/assets/ai-featuer.png",
    benefits: [
      "Unified dashboard",
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
              ...
              <div className="space-y-8">
                ...
                <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-xl rounded-full px-6 py-3 border border-white/40">
                  ...
                  <span className="text-white/90 text-sm font-medium uppercase tracking-[0.3em]">
                    Why Choose Us?
                  </span>
                </div>
                ...
                <div className="space-y-6">
                  <p className="text-lg lg:text-xl text-white/85 leading-relaxed font-light drop-shadow-md">
                    We've extensively studied the process to ensure a
                    frictionless experience, with our unique{" "}
                    <span className="font-semibold text-yellow-200">
                      Scan & Squeeze AI Identification
                    </span>{" "}
                    Fitter.
                  </p>

                  <p className="text-lg lg:text-xl text-white/85 leading-relaxed font-light drop-shadow-md">
                    The average mix preparation time using our system is just{" "}
                    <span className="font-semibold text-yellow-200">
                      57 seconds globally
                    </span>
                    . We understand that everything must be visual and without
                    screen taps, which is why we're a{" "}
                    <span className="font-semibold text-yellow-200">
                      Game Changer
                    </span>
                    .
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-white/70 max-w-2xl mx-auto">
                Experience the future of salon management with our AI-powered
                features
              </p>
            </div>
                      ...
                      >
                        ...
                        <div className="w-full h-full rounded-3xl overflow-hidden bg-white/10 backdrop-blur-2xl border border-white/20 shadow-2xl relative group">
                          ...
                          <div className="absolute top-6 left-6 z-10">
                            <div
                              className={`flex items-center gap-2 backdrop-blur-xl rounded-full px-3 py-1 border ${
                                isCenter
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                            ...
                            <div className="flex items-center gap-1 mb-4">
                              <div
                                className={`bg-gradient-to-br from-pink-400 to-rose-500 rounded-full border-2 border-white/50 flex items-center justify-center text-white font-semibold ${
                                  isCenter
                                    ? "w-10 h-10 text-sm"
                                    : "w-8 h-8 text-xs"
                                }`}
                              ...
                              <div
                                className={`bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full border-2 border-white/50 -ml-2 ${
                                  isCenter ? "w-9 h-9" : "w-7 h-7"
                                }`}
                              ></div>
                              <div
                                className={`bg-gradient-to-br from-green-400 to-emerald-500 rounded-full border-2 border-white/50 -ml-2 ${
                            ...
                            <h3
                              className={`font-semibold text-white mb-2 drop-shadow-lg ${
            ...
            <div className="text-center bg-white/25 backdrop-blur-xl rounded-3xl p-12 lg:p-20 border border-white/40 shadow-2xl">
              ...
              <div className="relative">
                ...
                <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto leading-relaxed font-light drop-shadow-md">
                  Join the revolution and transform your salon with color
