...
function segmentToUI(seg: CrmSegment): UISegment {
  return {
    ...
    serviceCategoryId: seg.serviceCategoryId ? CATEGORY_TO_LABEL[seg.serviceCategoryId] : undefined,
...
export function uiSegmentToCanonical(seg: UISegment, appointmentId: string): CrmSegment {
  return {
    ...
    serviceId: seg.serviceId,
    serviceName: seg.serviceName,
    serviceCategoryId: seg.serviceCategoryId ? LABEL_TO_CATEGORY[seg.serviceCategoryId] : undefined,
    segmentType: seg.segmentType,
    label: seg.label,
