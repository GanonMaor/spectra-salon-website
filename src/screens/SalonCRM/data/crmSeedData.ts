...
const STAFF: StaffMember[] = [
  ...
  { id: "e5", salonId: SALON_ID, name: "Talia Cohen",    role: "Keratin Expert",    roleId: "role-hair-stylist", departmentIds: ["dept-hair"], serviceIds: ["sv7", "sv8", "sv9", "sv10", "sv11", "sv14", "sv15"], color: "#B8A7D9", avatarUrl: "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?auto=format&fit=crop&w=96&q=80", status: "active", rating: 4.7, workingHours: SALON_HOURS },
  { id: "e6", salonId: SALON_ID, name: "Amit Bar",       role: "Cut & Style",       roleId: "role-hair-stylist", departmentIds: ["dept-hair"], serviceIds: ["sv2", "sv5", "sv9", "sv11", "sv14", "sv15"], color: "#A7C7E7", avatarUrl: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=96&q=80", status: "active", rating: 4.5, workingHours: SALON_HOURS },
  { id: "e7", salonId: SALON_ID, name: "Lihi Amar",      role: "Blond Specialist",  roleId: "role-color-specialist", departmentIds: ["dept-hair"], serviceIds: ["sv3", "sv4", "sv5", "sv6", "sv12", "sv13"], color: "#E8A6A0", avatarUrl: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=96&q=80", status: "active", rating: 4.8, workingHours: SALON_HOURS },
  { id: "e8", salonId: SALON_ID, name: "Omer Katz",      role: "Senior Barber",     roleId: "role-hair-stylist", departmentIds: ["dept-hair"], serviceIds: ["sv2", "sv11", "sv14", "sv15"], color: "#B9CFA5", avatarUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=96&q=80", status: "active", rating: 4.6, workingHours: SALON_HOURS },
