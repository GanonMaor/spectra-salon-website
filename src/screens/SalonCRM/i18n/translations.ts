...
const en: CrmTranslations = {
  ...
  analytics: {
    ...
    report: {
      ...
      bowl: "bowl",
      bowls: "bowls",
      clientDaysLastYear: "client-days (all history)",
      clientDayMaterialHint: "Full history · each row = one client in this category on one day (all mixes summed). Developers show % only. Scroll to load more.",
      noClientDayMaterials: "No recorded material usage for this category.",
      showingRowsOf: "Showing {shown} of {total}",
      loadMoreRows: "Scroll for more",
      date: "Date",
      client: "Client",
      materials: "Materials",
      visits: "Visits",
      ...
      financePilotHint: "Pilot preview shaped from your service activity — not yet from checkout or expense ledgers.",
      financePilotBadge: "pilot preview",
      retailRevenue: "Retail revenue",
      unitsSold: "Units sold",
      retailMargin: "Gross margin",
      topRetailProduct: "Top product",
      retailTrend: "Retail revenue trend",
      retailMix: "Retail mix",
      topRetailProducts: "Top retail products",
      retailByCategory: "Retail by category",
      retailCatShampoo: "Shampoo",
      retailCatTreatment: "Treatment",
      retailCatStyling: "Styling",
      retailCatColorCare: "Color care",
      retailCatOther: "Other",
      product: "Product",
      brand: "Brand",
      products: "products",
      ...
      largestExpense: "Largest item",
      expenseTrend: "Expense trend",
      expenseMix: "Expense mix",
      expenseBreakdown: "Expense breakdown",
      expensesByCategory: "Expenses by category",
      expenseCatRent: "Rent",
      expenseCatPayroll: "Payroll",
      expenseCatUtilities: "Utilities",
      expenseCatMarketing: "Marketing",
      expenseCatSupplies: "Supplies",
      expenseCatOther: "Other",
      expenseLabelRent: "Studio rent",
      expenseLabelPayroll: "Stylist payroll",
      expenseLabelUtilities: "Electricity & water",
      expenseLabelMarketing: "Ads & Instagram",
      expenseLabelSupplies: "Salon supplies",
      expenseLabelOther: "Insurance & misc",
      category: "Category",
      description: "Description",
      kind: "Type",
      amount: "Amount",
      operatingPreview: "operating preview",
      netProfitPreview: "after materials + operating preview",
    },
  },
};
...
const he: CrmTranslations = {
  ...
  analytics: {
    ...
    report: {
      ...
      bowl: "קערה",
      bowls: "קערות",
      clientDaysLastYear: "ימי־לקוחה (כל ההיסטוריה)",
      clientDayMaterialHint: "כל ההיסטוריה · כל שורה = לקוחה אחת בקטגוריה ביום אחד (כל המיקסים מסוכמים). לחמצן מוצג רק האחוז. גלול לטעינת עוד.",
      noClientDayMaterials: "אין צריכת חומרים מתועדת לקטגוריה זו.",
      showingRowsOf: "מציג {shown} מתוך {total}",
      loadMoreRows: "גלול לעוד רשומות",
      date: "תאריך",
      client: "לקוחה",
      materials: "חומרים",
      visits: "ביקורים",
      ...
      financePilotHint: "תצוגת פיילוט מבוססת על פעילות השירותים — עדיין לא מקופה או ממודול הוצאות.",
      financePilotBadge: "תצוגת פיילוט",
      retailRevenue: "הכנסות קמעונאות",
      unitsSold: "יחידות שנמכרו",
      retailMargin: "מרווח גולמי",
      topRetailProduct: "מוצר מוביל",
      retailTrend: "מגמת מכירות קמעונאיות",
      retailMix: "תמהיל קמעונאות",
      topRetailProducts: "מוצרים מובילים",
      retailByCategory: "מכירות לפי קטגוריה",
      retailCatShampoo: "שמפו",
      retailCatTreatment: "טיפול",
      retailCatStyling: "עיצוב",
      retailCatColorCare: "טיפוח צבע",
      retailCatOther: "אחר",
      product: "מוצר",
      brand: "מותג",
      products: "מוצרים",
      totalExpenses: "סה״כ הוצאות",
      fixedExpenses: "קבועות",
      variableExpenses: "משתנות",
      largestExpense: "הסעיף הגדול",
      expenseTrend: "מגמת הוצאות",
      expenseMix: "תמהיל הוצאות",
      expenseBreakdown: "פירוט הוצאות",
      expensesByCategory: "הוצאות לפי קטגוריה",
      expenseCatRent: "שכירות",
      expenseCatPayroll: "שכר",
      expenseCatUtilities: "חשבונות",
      expenseCatMarketing: "שיווק",
      expenseCatSupplies: "ציוד מתכלה",
      expenseCatOther: "אחר",
      expenseLabelRent: "שכירות הסטודיו",
      expenseLabelPayroll: "שכר מעצבים",
      expenseLabelUtilities: "חשמל ומים",
      expenseLabelMarketing: "פרסום ואינסטגרם",
      expenseLabelSupplies: "ציוד מתכלה לסלונים",
      expenseLabelOther: "ביטוח ושונות",
      category: "קטגוריה",
      description: "תיאור",
      kind: "סוג",
      amount: "סכום",
      operatingPreview: "תצוגת תפעול",
      netProfitPreview: "אחרי חומרים + תצוגת תפעול",
    },
  },
};
