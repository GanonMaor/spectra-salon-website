...
const coreTeam = [
  {
    ...
    description:
      "Professional hair colorist with 20+ years of experience. Founded Spectra to revolutionize salon operations through AI-powered intelligence.",
  ...
  },
  {
    ...
    description:
      "Technology expert with extensive experience in global development teams. Architect of the Spectra platform and AI systems.",
  ...
  },
  {
    ...
    description:
      "Business operations specialist focused on scaling technology solutions. Drives strategic growth and operational excellence.",
  ...
  },
  {
    ...
    description:
      "Leads operational excellence and strategic business development. Ensures seamless platform scaling for our growing artist community.",
    image: "/team/mika-bachur.jpg",
    fallback:
      "https://images.unsplash.com/photo-1494790108755-2616b612b97c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80",
  },
  {
    name: "Yaar Ben-Jay",
    age: 23,
    ...
    description:
      "Drives customer satisfaction through data insights and user experience optimization. Ensures maximum platform value for every artist.",
    image: "/team/yaar-ben-jay.jpg",
    fallback:
      "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80",
  },
];
...
const boardOfDirectors = [
  {
    ...
    description:
      "Former CMO at accessiBe with over a decade of experience in marketing and brand leadership for global technology companies.",
  ...
  },
  {
    ...
    description:
      "Former CEO of L'Oréal Israel with 24 years in beauty industry leadership. Expert in market growth and strategic business development.",
  ...
  },
  {
    ...
    description:
      "Founder of Retailx with proven expertise in scaling retail technology solutions. Acquired by NCR for $650M, bringing deep industry insights.",
    image: "/team/brian-cooper.jpg",
    fallback:
      "https://images.unsplash.com/photo-1556157382-97eda2d62296?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80",
  },
];
  ...
  return (
    <div className="bg-white w-full min-h-screen font-sans antialiased">
      ...
      <section className="relative pt-24 pb-20 lg:pt-32 lg:pb-28 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 text-center z-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/60 backdrop-blur-md rounded-full px-6 py-3 mb-10 border border-spectra-gold/30 shadow-sm">
            ...
            <span className="text-spectra-gold-dark text-sm font-medium uppercase tracking-wider">
              Our Story
            </span>
          </div>
          ...
          <p className="text-2xl lg:text-3xl text-spectra-charcoal-light max-w-4xl mx-auto leading-relaxed font-light mb-8">
            You pour your heart into every shade, every formula, every client's
            transformation.
          </p>
          <p className="text-xl text-spectra-charcoal/70 max-w-3xl mx-auto leading-relaxed">
            We're here to honor that artistry with tools that understand your
            craft as deeply as you do.
          </p>
        </div>
      </section>
      ...
      <section className="py-32 lg:py-40 bg-gradient-to-br from-slate-50 to-white relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div
            className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-br from-spectra-gold/5 to-rose-100/10 rounded-full blur-3xl animate-pulse"
            style={{ animationDuration: "6s" }}
          ></div>
          <div
            className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-br from-blue-100/10 to-spectra-cream/15 rounded-full blur-3xl animate-pulse"
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-7xl font-extralight text-slate-800 mb-6 tracking-[-0.02em]">
              We See{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-spectra-gold via-rose-400 to-blue-400 font-light">
                You
              </span>
            </h2>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              >
                ...
                >
                  <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 lg:p-12 shadow-[0_25px_80px_rgba(0,0,0,0.1)] border border-white/40 max-w-lg text-center">
                    ...
                    <h3 className="text-2xl lg:text-3xl font-light text-slate-800 mb-6 leading-tight">
                      ...
                      <span className="bg-clip-text text-transparent bg-gradient-to-r from-spectra-gold to-rose-400">
                        Every Formula
                      </span>
                    </h3>
                    <p className="text-slate-600 leading-relaxed font-light">
                      Whether you're perfecting that signature blonde or
                      building your dream salon
                    </p>
                  </div>
                </div>
                ...
                <div
                  ...
                  style={{
                    transform:
                      "translateY(-50%) translateZ(-20px) rotateY(15deg)",
                ...
                <div
                  className="absolute top-16 left-1/3 w-20 h-20 bg-gradient-to-br from-spectra-gold/20 to-rose-200/20 rounded-full blur-xl animate-pulse"
                  style={{ animationDelay: "1s" }}
                ></div>
                <div
                  className="absolute bottom-16 right-1/3 w-16 h-16 bg-gradient-to-br from-blue-200/20 to-purple-200/20 rounded-full blur-xl animate-pulse"
                  style={{ animationDelay: "3s" }}
                ></div>
                <div
                  className="absolute top-1/3 right-12 w-12 h-12 bg-gradient-to-br from-rose-200/20 to-orange-200/20 rounded-full blur-lg animate-pulse"
          ...
          <div className="text-center mt-20">
            <p className="text-xl lg:text-2xl text-slate-600 font-light max-w-4xl mx-auto leading-relaxed">
              Solo artist or salon owner, every stroke of genius deserves tools
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="text-center mb-20">
            <h2 className="text-4xl sm:text-5xl font-extralight text-spectra-charcoal mb-16 leading-tight tracking-wide">
              We See{" "}
              <span className="text-gradient-spectra font-light relative">
                You
              ...
              <div className="grid lg:grid-cols-3 gap-8 items-center">
                ...
                <div className="relative order-1">
                  <div className="relative w-full max-w-sm mx-auto">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden border-2 border-white/60 shadow-[0_20px_60px_rgba(212,196,168,0.2)]">
                      ...
                      <div
                        className="absolute bottom-8 left-8 w-2 h-2 bg-white/40 rounded-full blur-sm animate-pulse"
                        style={{ animationDelay: "1s" }}
                      ></div>
                    </div>
                    ...
                    <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 border border-spectra-gold/20 shadow-lg">
                      <p className="text-xs text-spectra-charcoal font-light tracking-wide">
                        🎨 Your artistry in action
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative order-3 lg:order-2">
                  ...
                  <div className="relative bg-white/80 backdrop-blur-sm rounded-[2rem] p-8 lg:p-10 border border-spectra-gold/15 shadow-[0_8px_40px_rgba(212,196,168,0.12)]">
                    ...
                    <div className="text-5xl text-spectra-gold/30 font-serif leading-none mb-4">
                      "
                    </div>

                    <blockquote className="text-lg lg:text-xl text-spectra-charcoal/90 leading-relaxed mb-6 font-light tracking-wide">
                      You're the artist who opens early and closes late. The one
                      who remembers exactly how Mrs. Chen likes her highlights,
                      who stays up researching the perfect formula for a
                      challenging color correction.
                      <br />
                      <br />
                      You're building something beautiful—whether it's a solo
                      practice or a growing salon—and every decision matters.
                    </blockquote>
                    ...
                    <p className="text-base text-spectra-charcoal/70 italic font-light leading-relaxed">
                      This is for you—the passionate professional who deserves
                      tools as dedicated as you are.
                    </p>

                    {/* Delicate closing quote mark */}
                    <div className="text-5xl text-spectra-gold/30 font-serif leading-none text-right mt-4">
                      "
                    </div>
                  </div>
                </div>
                ...
                <div className="relative order-2 lg:order-3">
                  <div className="relative w-full max-w-sm mx-auto">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden border-2 border-white/60 shadow-[0_20px_60px_rgba(212,196,168,0.2)]">
                      ...
                      {/* Small floating elements for magic */}
                      <div
                        className="absolute top-6 left-6 w-2 h-2 bg-spectra-gold/30 rounded-full blur-sm animate-pulse"
                        style={{ animationDelay: "0.5s" }}
                      ></div>
                      <div
                        className="absolute bottom-6 right-6 w-3 h-3 bg-spectra-gold/20 rounded-full blur-sm animate-pulse"
                        style={{ animationDelay: "2s" }}
                      ></div>
                    </div>
          ...
          <div className="grid lg:grid-cols-3 gap-10 mt-20">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-light text-spectra-charcoal mb-5 tracking-wide">
                Solo Artists
              </h3>
              <p className="text-spectra-charcoal-light leading-relaxed font-light">
                Whether you're building your dream chair rental or independent
                studio, every formula matters, every client is precious.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-spectra-charcoal-light leading-relaxed font-light">
                You're guiding talented artists, ensuring consistency while
                nurturing creativity. You need systems that work as hard as you
                do.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-spectra-charcoal-light leading-relaxed font-light">
                From your first client to your tenth stylist, we grow with you.
                Intelligence that scales from artistry to mastery.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="order-2 lg:order-1">
              <div className="relative">
                ...
                <div className="relative bg-white/90 backdrop-blur-sm rounded-[2rem] p-8 lg:p-10 shadow-[0_8px_40px_rgba(212,196,168,0.12)] border border-spectra-gold/15">
                  <h3 className="text-2xl font-light text-spectra-charcoal mb-6 tracking-wide">
                    From Frustration to Innovation
                  </h3>

                  <div className="space-y-6 text-lg text-spectra-charcoal-light leading-relaxed font-light">
                    <p>
                      "After 20 years behind the chair, I knew something had to
                      change. I was tired of watching talented colorists
                      struggle with the same problems I faced every day."
                    </p>
                    <p>
                      "Formulas scribbled on scraps of paper. Inventory that
                      disappeared overnight. The heartbreak of not being able to
                      recreate that perfect shade."
                    </p>
                    <p>
                      "But mostly, I was tired of seeing incredible artists
                      doubt themselves when the tools failed them, not their
                      talent."
                    </p>
                    ...
                    <p className="text-spectra-gold font-light italic text-xl">
                      "So we built something different. Something worthy of your
                      artistry."
                    </p>
                    <p className="text-sm text-spectra-charcoal/60 font-light tracking-wide">
                      — Maor Ganon
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-spectra-charcoal-light max-w-3xl mx-auto leading-relaxed font-light tracking-wide">
              Artists, engineers, and dreamers united by one mission: empowering
              your creativity
            </p>
          </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-6 lg:p-8 shadow-[0_8px_40px_rgba(212,196,168,0.08)] border border-spectra-gold/10 hover:shadow-[0_16px_60px_rgba(212,196,168,0.15)] hover:border-spectra-gold/20 transition-all duration-500 text-center h-full">
                    ...
                    <h4 className="text-lg font-light text-spectra-charcoal mb-2 tracking-wide">
                      {member.name}
                      <span className="text-spectra-charcoal/60 font-extralight">
                        , {member.age}
                      </span>
                    </h4>
                    <p className="text-spectra-gold font-light mb-4 text-sm tracking-wide">
                      {member.title}
                    </p>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-spectra-cream/30 to-spectra-gold/15">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h3 className="text-3xl font-light text-spectra-charcoal mb-8 tracking-wide">
                To Every Artist We Serve
              </h3>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-1.5 h-1.5 bg-spectra-gold rounded-full mt-3 flex-shrink-0"></div>
                  <div>
                    <h4 className="font-light text-spectra-charcoal mb-2 text-lg tracking-wide">
                      We Honor Your Expertise
                    </h4>
                    <p className="text-spectra-charcoal-light leading-relaxed font-light">
                      Our AI learns from you, not the other way around. Your
                      years of experience guide every algorithm.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-light text-spectra-charcoal mb-2 text-lg tracking-wide">
                      We Preserve Your Artistry
                    </h4>
                    <p className="text-spectra-charcoal-light leading-relaxed font-light">
                      Every formula, every technique, every breakthrough becomes
                      part of your growing intelligence.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-spectra-charcoal-light leading-relaxed font-light">
                      Tools that help you serve more clients, create more
                      beauty, and build the business you've dreamed of.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-[2rem] p-8 lg:p-10 shadow-[0_8px_40px_rgba(212,196,168,0.12)] border border-spectra-gold/15">
                <blockquote className="text-xl lg:text-2xl text-spectra-charcoal leading-relaxed italic mb-6 font-light tracking-wide">
                  "Technology should feel like an extension of your hands, not a
                  barrier to your creativity. We're building tools that
                  disappear into your workflow and amplify what you already do
                  brilliantly."
                </blockquote>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-light text-spectra-charcoal tracking-wide">
                      Our commitment to you
                    </p>
                    <p className="text-sm text-spectra-charcoal/60 font-light">
                      Every day, every feature, every update
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="relative max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-extralight text-white mb-6 tracking-wide">
              Growing{" "}
              <span className="text-spectra-gold font-light relative">
                Together
                <div className="absolute -bottom-2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-spectra-gold/60 to-transparent"></div>
              </span>
            </h2>
            <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed font-light tracking-wide">
              Every number represents an artist whose craft we're honored to
              support
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="relative mb-4">
                <div className="text-5xl lg:text-6xl font-extralight text-spectra-gold mb-4 transition-transform duration-500 group-hover:scale-110">
                  500+
                </div>
              ...
              <div className="text-white/90 font-light text-lg mb-2 tracking-wide">
                Artists Supported
              </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-white/60 text-sm font-light">
                When artistry meets intelligence
              </div>
            </div>
          </div>
        </div>
