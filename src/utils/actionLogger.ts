...
class ActionLogger {
  ...
  async logNavigation(fromPage: string, toPage: string, method: 'click' | 'url' = 'click') {
  ...
  async logButtonClick(buttonName: string, location: string, additionalData?: Record<string, any>) {
  ...
  async logDataView(dataType: string, filters?: Record<string, any>, resultCount?: number) {
